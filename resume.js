...
function generateCV() {
    ...
    // Add basic info
    resumePreview.innerHTML += '<h1>' + formData.get('firstname') + ' ' + formData.get('middlename') + ' ' + formData.get('lastname') + '</h1>';
    ...
    achievements.forEach((achieve) => {
        resumePreview.innerHTML += '<p>' + achieve.achieve_title + ': ' + achieve.achieve_description + '</p>';
    });
    ...
    experiences.forEach((exp) => {
        resumePreview.innerHTML += '<p>' + exp.exp_title + ' at ' + exp.exp_organization + ' (' + exp.exp_location + ')</p>';
        resumePreview.innerHTML += '<p>' + exp.exp_start_date + ' - ' + exp.exp_end_date + '</p>';
    ...
    educations.forEach((edu) => {
        resumePreview.innerHTML += '<p>' + edu.edu_school + ' (' + edu.edu_city + ')</p>';
        resumePreview.innerHTML += '<p>' + edu.edu_degree + '</p>';
        resumePreview.innerHTML += '<p>' + edu.edu_start_date + ' - ' + edu.edu_end_date + '</p>';
    });
}
