...
// let jobSuggestion = document.querySelector(".ai-content");
...
//   // Create a resume preview container
...
//     "</h1>";
//   resumePreview.innerHTML += "<p>" + formData.get("designation") + "</p>";
//   resumePreview.innerHTML += "<p>" + formData.get("address") + "</p>";
//   resumePreview.innerHTML += "<p>" + formData.get("email") + "</p>";
//   resumePreview.innerHTML += "<p>" + formData.get("phoneno") + "</p>";
//   resumePreview.innerHTML += "<p>" + formData.get("summary") + "</p>";

//   // Add achievements
//   const achievements = formData.getAll("group-a");
//   resumePreview.innerHTML += "<h2>Achievements</h2>";
//   achievements.forEach((achieve) => {
//     resumePreview.innerHTML +=
//       "<p>" +
//       achieve.achieve_title +
//       ": " +
//       achieve.achieve_description +
//       "</p>";
//   });

//   // Add experience
//   const experiences = formData.getAll("group-b");
//   resumePreview.innerHTML += "<h2>Experience</h2>";
...
//     resumePreview.innerHTML += "<p>" + exp.exp_description + "</p>";
//   });

//   // Add education
//   const educations = formData.getAll("group-c");
//   resumePreview.innerHTML += "<h2>Education</h2>";
//   educations.forEach((edu) => {
//     resumePreview.innerHTML +=
//       "<p>" + edu.edu_school + " (" + edu.edu_city + ")</p>";
//     resumePreview.innerHTML += "<p>" + edu.edu_degree + "</p>";
//     resumePreview.innerHTML +=
...
//   const blob = new Blob([resumePreview], { type: "application/msword" });
...
// // add btn for new field-------------------
// let repeaterAddBtn = document.querySelector(".repeater-add-btn");

// repeaterAddBtn.addEventListener("click", () => {
//   addSkillsInput();
// });
// function addSkillsInput() {
//   const newSkillInput = document.createElement(
//     "cv-form-row cv-form-row-skills"
//   );
//   newSkillInput.type = "text";
//   newSkillInput.name = "skill";
//   document.querySelector(".form-elem").appendChild(newSkillInput);
// }
...
// const API_KEY = "AIzaSyAJ6cclHluGc_yBs8cE3x5ghcuLglC5yAg";
...
//         prompt = prompt + element.innerHTML + " ";
//     });
//     prompt += " Advance roadMap with these skills";
//     Search(prompt, heading);
//     console.log(prompt);
// });
